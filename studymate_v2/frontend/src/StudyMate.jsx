  ...
  return (
    <div className="sm-z sm-fadeup" style={{ padding: 24 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
        <button className="sm-btn sm-btn-primary" style={{ justifyContent: "center" }} onClick={onLearn} disabled={cards.length === 0} title={cards.length === 0 ? "Füge zuerst Karten hinzu" : undefined}>
          <Brain size={15} />
          Lernen starten
        </button>
        <button className="sm-btn sm-btn-ghost" style={{ justifyContent: "center", borderColor: "rgba(139,92,246,.3)", color: "#a78bfa" }} onClick={onQuiz} disabled={cards.length === 0} title={cards.length === 0 ? "Füge zuerst Karten hinzu" : undefined}>
          <Zap size={15} />
          Quiz starten
        </button>
      </div>
